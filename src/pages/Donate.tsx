                    ...
                    <div className="flex flex-col items-center gap-5 w-full">
                      ...
                      <div className="w-full flex flex-col items-center justify-center bg-slate-50 p-4 rounded-2xl border border-slate-200 shadow-sm">
                        <div className="w-48 h-48 sm:w-52 sm:h-52 bg-white p-3 rounded-xl border border-slate-200 shadow-inner flex items-center justify-center mb-3">
                          <img
                            src={`https://api.qrserver.com/v1/create-qr-code/?size=250x250&data=upi://pay?pa=unmesh@upi%26pn=Unmesh%20Foundation%26am=${selectedAmountValue}%26tn=${donationRefId}`}
                            alt="UPI QR Code"
                      ...
                      <div className="space-y-3 w-full">
                        <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                          ...
                          <div className="flex items-center justify-between gap-2">
                            <span className="font-mono font-bold text-slate-900 text-sm sm:text-base break-all">unmesh@upi</span>
                            <button
                              onClick={() => copyToClipboard('unmesh@upi', 'upi')}
                        ...
                        <div className="p-3 rounded-xl bg-blue-50 border border-blue-100 text-xs text-[#163E96] font-semibold leading-relaxed">
                          Open Google Pay, PhonePe, Paytm or any UPI app, scan the QR code above or send directly to <strong className="font-mono bg-blue-100 px-1 py-0.5 rounded text-[#163E96]">unmesh@upi</strong>.
                        </div>
                      </div>
                    </div>
                  </div>
